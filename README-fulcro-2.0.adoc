...
* Dynamic queries work. A few things need more testing
...
* New history recording in place, but not yet integration tested with viewer
* A number of new cool features like mutation joins, and auto-mergable return values from server mutations
