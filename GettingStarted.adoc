...
So, Om includes a function called `tree->db` that can simultaneously walk a data tree (initial-state) and a
...
figure out what auto-normalization might fail.
...
many of the common bases. You can always get started with the easy one, and upgrade
