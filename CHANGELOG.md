...
3.7.2
-----
- Make fulcro apps more friendly when printed by accident.
...
- Added missing calls to `force-children` that affect bindings in 
release builds.

3.0.0-beta-16
-------------
- Added dev warning about bad react keys.
- Got rid of warning generated by form inputs.
- Made component warnings/errors only visible in dev mode.
