(ns untangled-devguide.F-Untangled-Client
...
(defcard-doc
  ...
  You should definitely read the next section about [the InitialAppState mechanism](#!/untangled_devguide.F_Untangled_Initial_App_State). It
