...
image::https://img.shields.io/clojars/v/untangled/untangled.svg[link=https://clojars.org/untangled/untangled]
...
Snapshot: image:https://api.travis-ci.org/awkay/untangled.svg?branch=develop[link=https://github.com/untangled/untangled/tree/develop]
